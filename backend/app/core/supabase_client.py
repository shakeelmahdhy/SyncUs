...
def get_supabase_anon_client():
    """
    Backwards-compatible alias for the Supabase anon / publishable client.

    Some modules (e.g. accounts) still import this name. It delegates to
    ``get_supabase_publishable_client()`` and uses ``SUPABASE_PUBLISHABLE_KEY``.
    """
