...
def _ensure_own_profile(current_user: CurrentUserDep, user_id: UUID) -> None:
...
def create_profile(payload: UserCreateRequest, current_user: CurrentUserDep) -> UserResponse:
    ...
    """
    _ensure_own_profile(current_user, payload.user_id)
...
def get_profile(user_id: UUID, current_user: CurrentUserDep):
    ...
    _ensure_own_profile(current_user, user_id)
...
def parse_profile(user_id: UUID, current_user: CurrentUserDep):
    """Return normalized profile data for the authenticated user."""
    _ensure_own_profile(current_user, user_id)
...
def update_profile(user_id: UUID, payload: UserUpdateRequest, current_user: CurrentUserDep) -> UserResponse:
